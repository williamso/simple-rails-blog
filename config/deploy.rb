...
# =============================================================================
set :user, "cafecomjava"
set :domain, "www.hunterco.com.br"
set :application, "simple-rails-blog"

set :repository, "cafecomjava@www.hunterco.com.br:~/repo/simple-rails-blog.git"
set :remote_repo, 'simple-rails-blog'
set :branch, 'master'
